...
workerForm.addEventListener("submit", async function(e){
    ...
    if(type === "press"){
        ...
        const pressCount = document
            .getElementById("pressCount")
            .value
            .trim();

        const owner = document
            .getElementById("pressOwner")
            .value
            .trim();

        const payment = document
            .getElementById("pressPayment")
            .value;
    ...
    if(type === "jatka"){
        ...
        const landArea = document
            .getElementById("landArea")
            .value
            .trim();

        const owner = document
            .getElementById("jatkaOwner")
            .value
            .trim();

        const payment = document
            .getElementById("jatkaPayment")
            .value;
...
function updateDashboard(data){
    ...
    document.getElementById("pressJobs").innerText=

        data.filter(x=>x.type==="Press").length;

    document.getElementById("jatkaJobs").innerText=

        data.filter(x=>x.type==="Jatka").length;

    document.getElementById("paidJobs").innerText=

        data.filter(x=>x.payment==="Ha").length;

    document.getElementById("unpaidJobs").innerText=

        data.filter(x=>x.payment==="Yo'q").length;
